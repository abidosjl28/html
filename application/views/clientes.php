                ...
                <tbody>
                  ...
                  foreach ($clientes as $cliente) {
                    ...
                    <tr data-id="<?=$cliente['id']?>">
                      ...
                      <td class="text-left"><?=$cliente['nombre']?> <?=$cliente['apellidoP']?> <?=$cliente['apellidoM']?></td>
                      <td class="text-left"><?=$cliente['dirCalle']?> #<?=$cliente['dirNumero']?> Col. <?=$cliente['dirColonia']?> , <?=$cliente['dirMunicipio']?>, <?=$cliente['dirEstado']?></td>
