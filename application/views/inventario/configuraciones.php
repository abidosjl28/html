            ...
            <form  id="formName" autocomplete="off">
              ...
              <div class="col-md-9">
                <div class="box box-default">
                  ...
                  <div class="box-body box-profile">
                    <form  id="formTiketera" autocomplete="off">
                      <div class="container-fluid">
                        <div class="form-group">
                          <label for="exampleInputEmail1">Direccion de la impresora</label>
                          <input type="text" maxlength="50" class="form-control" name="tiketera" id="exampleInputEmail1" placeholder="\\mipc\\tiketera" value="<?=$mitiketera?>">
                        </div>
                        <div class="form-group">
                          <button type="submit" class="btn btn-success"><i class="fa fa-thumbs-o-up" aria-hidden="true"></i> Guardar</button>
                        </div>
